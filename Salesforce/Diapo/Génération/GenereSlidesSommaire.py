...
def main():
    ...
    slide_id_source = 'A9yuOUAomUaxslpIiAzYE2Su2PWE'
    ...
    result2 = subprocess.run(['python3', 'CreeZoneTxtSommaire.py', presentation_id_destination, idDiapoDestination], capture_output=True, text=True)
    print("Résultat de CreeZoneTxtSommaire.py :")
